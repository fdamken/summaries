...
\colorlet{ambiguityorange}{tud8b}
    ...
    \chapter{Introduction} % 11, 11.4
        ...
        \section{Language and Knowledge Processing} % 11.5, 11.6
            ...
            \subsection{Examples}
	            ...
	            \subsubsection{Automatic Summorization} % 11.21
		            \begin{description}
		            	\item[Given] A document collection.
           		...
           		\begin{figure}[H]
           			...
           			\begin{tikzpicture}
	           			\begin{axis}[
		           			...
		           			\addplot [->] coordinates { (0, 0) (7, 3) } node[above]{D1};
		           			\addplot [->] coordinates { (0, 0) (3, 5) } node[above]{D2};
		           			\addplot [->, tud10b] coordinates { (0, 0) (6, 7) } node[above]{Q};
	           			\end{axis}
           			\end{tikzpicture}
           		\end{figure}
    ...
    \chapter{Information Extraction and Classification} % 17, (18)
        ...
        \section{Entity Recognition} % -
            ...
            \subsection{Approaches} % -
                ...
                \subsubsection{Rule-bases Methods} % 17.11, 17.12
                    \begin{itemize}
        ...
        \section{Supervised vs. Probabilistic Machine Learning} % 17.13, 17.14, 17.15
            \begin{itemize}
