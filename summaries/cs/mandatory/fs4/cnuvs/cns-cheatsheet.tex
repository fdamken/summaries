...
\usepackage{epstopdf}
\tcbuselibrary{skins}
\usetikzlibrary{arrows.meta, shapes, backgrounds, chains, calc, scopes}
...
\providecommand{\mayfail}[1]{\color{errorred}\textbf{\texttt{#1}}}
\providecommand{\changed}[1]{\color{changedpurple}\textbf{\texttt{#1}}}
...
\begin{document}
    ...
    \chapter{OSI Schichtenmodell}
        ...
        \begin{figure}[H]
        	\centering
        	\begin{tikzpicture}[layer/.style = { draw, rectangle, minimum width = 4cm, align = center, minimum height = 1.2cm }, transit/.style = { minimum width = 2cm, minimum height = 0.5cm }, virtual/.style = { color = virtual, text = black }]
	        	% Layers Left.
	        	\node [layer] (layer1Left) {1 \\ Physical Layer};
            ...
            \subsection{Drei-Wege Handschlag} % 4.24, 4.25, 4.26, 4.27, 4.32
	            ...
	            \begin{figure}[H]
	            	...
	            	\begin{tikzpicture}[->]
		            	...
		            	\draw (e) to node[above]{AK} node[below](dt){DT} (f);
        ...
        \section{Congestion Control}
            ...
            \subsection{Pakete Verwerfen, Implizites Feedback, Mögliche Aktionen}
	            ...
	            \paragraph{Erhalt von Feedback}
		            ...
		            Dies wird bei TCP näher betrachtet (\ref{sec:tcp_congestion_control}).
	            % end
            % end
            ...
            \subsection{Diagramme} % 5.11, 5.37
                \paragraph{Zeitdiagramme}
	                \begin{figure}[H]
	                	...
	                	\begin{tikzpicture}
							...
							\path [fill = tud2a] (a00) to (a01) to (a02) to (a03) to (a04) to (a05) to (a06) to (a07) to (a08) to (a09) to (a10) to (a11) to (a12) to (a13) to (a14) to (a15) to (d13) to (d12) to (d11) to (d10) to (d09) to (d08) to (d07) to (d06) to (d05) to (d04) to (d03) to (d02) to (d01) to (d00);
		                	\draw [fill = tud9a, draw = tud6b, line width = 1pt] (n01) to (n02) to (n03) to (n04) to (n05) to (n06) to (n07) to (n08) to (n09) to (n10) to (n11) to (n12) to (n13) to (n14) to (n15) to (n16) to (n17) to (n18) to (n19) to (n20) to (n21) to (n22) to (n23) to (n00);
		                	\draw [draw = tud4c, line width = 1pt] (a00) to (a01) to (a02) to (a03) to (a04) to (a05) to (a06) to (a07) to (a08) to (a09) to (a10) to (a11) to (a12) to (a13) to (a14) to (a15);
		                	\draw [draw = tud10a, line width = 1pt] (d00) to (d01) to (d02) to (d03) to (d04) to (d05) to (d06) to (d07) to (d08) to (d09) to (d10) to (d11) to (d12) to (d13);
	                	...
	                	\label{fig:queueing_time_fragram}
	                \end{figure}
                % end
                ...
                \paragraph{Transitionsdiagramme}
	                \begin{figure}[H]
	                	...
	                	\label{fig:queueing_transition_diagram}
	                \end{figure}
                % end
            % end
