	...
	\section{Die Visuelle Abbildung}
		...
		\subsection{Visuelle Strukturen}
			...
			\subsubsection{Glyphen}
				...
				\begin{figure}
					\centering
					\includegraphics[width=0.8\linewidth]{glyphen-dark}
...
\chapter{Spezialisierte Visualisierungstechniken}
	...
	\section{Hochdimensionale Daten}
		...
		\subsection{Quantitative Daten}
			...
			\subsubsection{Scatterplot-Matrix}
				...
				\begin{figure}
					\centering
					\includegraphics[width=\linewidth]{scatterplotmatrix-dark}
			...
			\subsubsection{Starplot}
				...
				\begin{figure}
					\centering
					\includegraphics[width=0.35\linewidth]{starplot-dark}
			...
			\subsubsection{Parallele Koordinaten}
				...
				\begin{figure}
					\centering
					\includegraphics[width=0.5\linewidth]{parallelekoordinaten-dark}
			...
			\subsubsection{RadViz}
				...
				\begin{figure}
					\centering
					\includegraphics[width=0.3\linewidth]{radviz-dark}
		...
		\subsection{Kategorische Daten}
			...
			\subsubsection{Parallel Sets}
				...
				\begin{figure}
					\centering
					\includegraphics[width=0.9\linewidth]{parallelsets-dark}
			...
			\subsubsection{Mosaik-Plot}
				...
				\begin{figure}
					\centering
					\includegraphics[width=0.8\linewidth]{mosaicplot-dark}
	...
	\section{Zeitbasierte Daten}
		...
		\subsection{Viele Zeitreihen}
			...
			\subsubsection{Horizon Plots}
				...
				\begin{figure}
					\centering
					\includegraphics[width=\linewidth]{horizonplot-dark}
		...
		\subsection{Periodische Zeitreihen}
			...
			\subsubsection{Spirallayout}
				...
				\begin{figure}
					\centering
					\includegraphics[width=0.5\linewidth]{spirallayout-dark}
	...
	\section{Graphen und Bäume}
		...
		\subsection{Bäume} % 7.35, 7.47
			...
			\subsubsection{Node-Link-Diagramm}
				...
				\begin{figure}
					\centering
					\includegraphics[width=0.5\linewidth]{nodelinkdiagram-dark}
			...
			\subsubsection{TreeMaps}
				...
				\begin{figure}
					\centering
					\includegraphics[width=0.5\linewidth]{treemap-dark}
			...
			\subsubsection{Icicle-Plots und Sunburst}
				...
				\begin{figure}
					...
					\begin{subfigure}{0.49\linewidth}
						\centering
						\includegraphics[width=0.5\linewidth]{icicle-dark}
						\caption{Icicle-Plot}
					\end{subfigure}
					\hfill
					\begin{subfigure}{0.49\linewidth}
						\centering
						\includegraphics[width=0.5\linewidth]{sunburst-dark}
						\caption{Sunburst}
					\end{subfigure}
	...
	\section{Ortsbezogene Daten und Karten}
		...
		\subsection{Karten als Metapher}
			...
			\begin{figure}
				\centering
				\includegraphics[width=0.75\linewidth]{mapabstraction-dark}
		...
		\subsection{Ortsbezogene Daten}
			...
			\subsubsection{Kartenprojektion}
				...
				\begin{figure}
					\centering
					\includegraphics[width=0.3\linewidth]{tissotworld-dark}
				...
				\paragraph{Mercator-Projektion}
					...
					\begin{figure}
						\centering
						\includegraphics[width=0.6\linewidth]{mercator-dark}
...
\chapter{Visual Analytics}
	...
	\section{Definition}
		...
		\subsection{Definition nach Thomas und Cook}
			...
			\begin{figure}
				\centering
				\includegraphics[width=\linewidth]{va-dark}
...
\chapter{Kognitive Psychologie}
	...
	\section{Kognitive Psychologie}
		...
		\subsection{Mentale Modelle}
			...
			\begin{figure}
				\centering
				\includegraphics[width=0.8\linewidth]{mentalemodelle-dark}
	...
	\section{Evaluation und Design-Studien} % 13.66, 13.85
		...
		\subsection{Testmethoden}
			...
			\begin{figure}
				\centering
				\includegraphics[width=0.8\linewidth]{evaluation-dark}
