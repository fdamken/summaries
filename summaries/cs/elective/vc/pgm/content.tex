...
\chapter{Approximate Inference}
	...
	\section{Message Passing in Factor Graphs} % 8.3, 8.4, 8.5, 8.6, 8.7, 8.8, 8.9, 8.10, 8.11
		...
		\subsection{Autoregressive Generative Models}
			...
			\begin{center}
				\begin{tikzpicture}[->]
					...
					\node [rv, right = 1 of X4, draw = white] (Xd) {\( \cdots \)};
					\node [rv, right = 1 of Xd] (Xn) {\( X_n \)};
