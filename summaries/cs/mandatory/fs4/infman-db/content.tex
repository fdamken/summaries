...
\chapter{Logische Datenmodellierung} % 4
	...
	\section{Datenbanknormalisierung} % 4.42, 4.43, 4.44
		...
		\subsection{Normalformen und Normalisierung} % 4.49, 4.60, 4.75, 4.81
			...
			\subsubsection{Erste Normalform} % 4.61, 4.62, 4.63
				...
				\info{Flapsig: Attribute sind atomar, alles hängt vom Schlüssel ab.}
				% end
			...
			\subsubsection{Vierte Normalform} % 4.74, 4.75
				...
				\paragraph{Mehrwertige Abhängigkeit}
					...
					\end{itemize}
					\info{Flapsig: Attribute hängen nur vom Schlüssel ab und keine Redundanz durch Auflistungen.}
					% end
					% end
	...
	\section{Normalformen und Performanz} % 4.86
		\begin{itemize}
...
\chapter{Logische Abfragemodelle} % 5, 5.3, 5.4
	...
	\section{Änderungsoperationen} % 5.44, 5.45
		\begin{itemize}
