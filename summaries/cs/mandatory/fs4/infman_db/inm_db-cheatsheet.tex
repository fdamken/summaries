...
\tcbuselibrary{skins}
\usetikzlibrary{arrows.meta, shapes, backgrounds, chains, calc, scopes, decorations.pathmorphing, patterns, er, positioning}

% Basic information.
\title{Informationsmanagement \\ Datenbanken}
...
\providecommand{\STAR}{\raisebox{-0.05cm}{\tikz{\node[draw, star, star point height = 0.7em, scale = 0.5] {};}}}
                ...
                \subsubsection{Kardinalitäten} % 3.37, 3.38, 3.39, 3.40
                	...
                	\begin{figure}[H]
                		...
                		\begin{tikzpicture}[auto, node distance = 2]
	                		...
	                		\draw (left) -- node[above]{\textcolor{tud4c}{[1, 1]}} node[below]{\textcolor{tud1b}{1}} (rel);
	                		\draw (rel) -- node[above]{\textcolor{tud4c}{[1, 1]}} node[below]{\textcolor{tud1b}{1}} (right);
                		\end{tikzpicture}
              		...
              		\end{figure}
               		\begin{figure}[H]
               			...
               			\begin{tikzpicture}[auto, node distance = 2]
                			...
                			\draw (left) -- node[above]{\textcolor{tud4c}{[1, *]}} node[below]{\textcolor{tud1b}{1}} (rel);
                			\draw (rel) -- node[above]{\textcolor{tud4c}{[1, 1]}} node[below]{\textcolor{tud1b}{N}} (right);
               			\end{tikzpicture}
               		...
               		\begin{figure}[H]
               			...
               			\begin{tikzpicture}[auto, node distance = 2]
                			...
                			\draw (left) -- node[above]{\textcolor{tud4c}{[0, *]}} node[below]{\textcolor{tud1b}{N}} (rel);
                			\draw (rel) -- node[above]{\textcolor{tud4c}{[1, *]}} node[below]{\textcolor{tud1b}{N}} (right);
               			\end{tikzpicture}
    ...
    \chapter{Logische Datenmodellierung} % 4
        ...
        \section{Datenbanknormalisierung} % 4.42, 4.43, 4.44
            ...
            \subsection{Normalformen und Normalisierung} % 4.49, 4.60, 4.75, 4.81
            	...
            	\textbox{\enquote{The key, the whole key and nothing but the key. So help me Codd!}}

                \subsubsection{Erste Normalform} % 4.61, 4.62, 4.63
                	\textbf{Eine Relation ist in 1NF, wenn \textit{alle Attributwerte atomar} sind.}
                	
                	\textbox{Flapsig: Attribute sind automar, alles hängt vom Schlüssel ab.}
                % end
                ...
                \subsubsection{Zweite Normalform} % 4.65, 4.66, 4.67
                    ...
                    \textbox{Flapsig: NPA hängen vom gesamte Schlüssel ab.}
                % end
                ...
                \subsubsection{Dritte Normalform} % 4.69, 4.70, 4.71
                    ...
                    \textbox{Flapsig: NPA hängen nur vom Schlüssel ab, keine transitiven FDs.}
                % end
                ...
                \subsubsection{Boyce-Codd Normalform} % 4.72, 4.73
                    ...
                    \textbox{Flapsig: Attribute hängen nur vom Schlüssel ab, keine transitiven FDs.}
                % end
            % end
...
DROP INDEX *@\textit{indexname}@*;
    ...
    \chapter{Neuere Datenbankkonzepte (Ausblick)} % 10
        ...
        \section{CAP-Theorem, Brewers Theorem} % 10.10
        	...
        	\textbox{Brewer: Es können nicht alle drei Kriterien zeitgleich optimiert werden.}
        % end
    % end
\end{document}
