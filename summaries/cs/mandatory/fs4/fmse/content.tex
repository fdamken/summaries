	...
	(_nr_pr == 1) -> printf("ready")
		...
		\subsection{Local and Global Data}
			...
			\subsubsection{Interference of Global Data}
				...
				\begin{figure}
					\centering
					\includegraphics[width = \textwidth]{tmp-promela-interference\IfDarkModeT{-inverted}}
...
active [2] proctype P() {
	...
	n = 2
			...
			\begin{figure}[H]
				\centering
				\includegraphics[width = \textwidth]{tmp-promela-computations\IfDarkModeT{-inverted}.pdf}
			...
			\subsubsection{Interleaving}
				...
				\begin{figure}
					\centering
					\includegraphics[width = \textwidth]{tmp-promela-interleavings\IfDarkModeT{-inverted}.pdf}
...
%				% end
	...
	\section{Kripke Structure and Transition Systems}
		...
		\begin{figure}
			\centering
			\includegraphics[width = \textwidth]{tmp-ltl-kripkestruct\IfDarkModeT{-inverted}}
