            ...
            \begin{itemize}
	            \item Intel x86 defines multiple protection "rings".
		            \begin{figure}[H]
		            	\centering
		            	\begin{tikzpicture}
			            	\draw [line width = 2pt, fill = TUDa-4a] (0, 0) circle (4);
			            	\draw [line width = 2pt, fill = TUDa-6a] (0, 0) circle (3);
			            	\draw [line width = 2pt, fill = TUDa-8a] (0, 0) circle (2);
			            	\draw [line width = 2pt, fill = TUDa-9a] (0, 0) circle (1);
            ...
            \subsubsection{Execution Trajectories} % 4.23, 4.24
	            \begin{figure}[H]
	            	...
	            	\begin{tikzpicture}
		            	...
		            	\draw [line width = 2pt, color = TUDa-9b] (2, 3) rectangle (3, 4);
    ...
    \section{Taxonomy of Software Misbehavior}
        \begin{figure}[H]
        	...
        	\begin{tikzpicture}
            	...
            	\draw [color = transparent, fill = TUDa-0c, opacity = 0.5] (left) circle (2);
            	\draw [color = transparent, fill = TUDa-0c, opacity = 0.5] (right) circle (2);
            	\draw [line width = 2pt, color = TUDa-0d] (left) circle (2);
            	\draw [line width = 2pt, color = TUDa-0d] (right) circle (2);
