...
endrule
		...
		\section{Synthetisierung}
			Die Synthetisierung kann mit einigen Attributen beeinflusst werden, siehe \ref{sec:bsv_komponenten}.
		% END
		
		\section{Komponenten}
			\label{sec:bsv_komponenten}
...
ports[N - 1]._read < ports[N - 1].write
    ...
    \chapter{Abkürzungen}
	    \begin{description}
		    \csvreader[head to column names]{abbreviations.csv}{}{
