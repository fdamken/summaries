...
\newcommand{\sign}{\ensuremath{\textrm{sign}}}
					...
					\begin{figure}
						...
						\begin{tikzpicture}
							\begin{axis}[
								...
								\addplot [color = tud1b, line width = 2pt, smooth] { 1 / (1 + exp(-x)) };
							\end{axis}
						\end{tikzpicture}
					...
					\begin{figure}
						...
						\begin{tikzpicture}
							\begin{axis}[
								...
								\addplot [color = tud1b, line width = 2pt, smooth] { tanh(x) };
							\end{axis}
						\end{tikzpicture}
					...
					\begin{figure}
						...
						\begin{tikzpicture}
							\begin{axis}[
								...
								\addplot [color = tud1b, line width = 2pt, no marks] { max(0, x) };
							\end{axis}
						\end{tikzpicture}
