...
\chapter{OSI Schichtenmodell}
    ...
    \begin{figure}[H]
    	\centering
    	\begin{tikzpicture}[layer/.style = { draw, rectangle, minimum width = 4cm, align = center, minimum height = 1.2cm }, transit/.style = { minimum width = 2cm, minimum height = 0.5cm }, virtual/.style = { color = TUDa-0b, text = black }]
        	% Layers Left.
