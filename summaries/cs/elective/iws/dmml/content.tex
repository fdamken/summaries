...
\chapter{Einleitung}
	...
	\section{Geschichte}
		...
		\begin{description}[leftmargin = 2cm]
			...
			\item[2010er] Ära des tiefen Lernens
		\end{description}
...
\chapter{Grundlagen}
	...
	\section{CRISP-DM: Verlaufsmodell des Data Mining}
		...
		\begin{figure}
			\centering
			\includegraphics[width=0.5\linewidth]{img/crisp-dm\IfDarkModeT{-dark}}
			...
			\begin{figure}
				...
				\resizebox{0.5\linewidth}{!}{
					\begin{tikzpicture}
						...
						\draw [->, color = TUDa-3\IfDarkModeTF{a}{d}] (cMinus) -- node[above, pos = 0.75]{\(\vec{w}\)} (cPlus);
						\draw [->, color = TUDa-11\IfDarkModeTF{a}{b}] (origin) -- node[below]{\(\vec{c}_-\)} (cMinus);
						\draw [->, color = TUDa-11\IfDarkModeTF{a}{b}] (origin) -- node[above, xshift = -3pt]{\(\vec{c}_+\)} (cPlus);
						\draw [->, color = TUDa-11\IfDarkModeTF{a}{b}] (origin) -- node[above]{\(\vec{c}\)} (center);
						\draw [->, color = TUDa-1\IfDarkModeTF{a}{b}] (origin) -- node[below]{\(\vec{x}\)} (x);
						\draw [->, color = TUDa-9\IfDarkModeTF{a}{c}] (center) -- node[above, pos = 0.8, xshift = 12pt]{\(\vec{x} - \vec{c}\)} (x);
	...
	\section{Dendrogramme und Hierarchische Cluster-Analyse}
		...
		\begin{figure}
			...
			\begin{tikzpicture}
				...
				\node [draw, circle, fill = fgcolor, inner sep = 3pt, below = 1.5 of aL] (aLb) {};
				\node [draw, circle, fill = fgcolor, inner sep = 3pt, below = 0.5 of aRbLcL] (aRbLcLd) {};
				\node [draw, circle, fill = fgcolor, inner sep = 3pt, below = 0.5 of aRbLcR] (aRbLcRd) {};
				\node [draw, circle, fill = fgcolor, inner sep = 3pt, below = 0.5 of aRbRcL] (aRbRcLd) {};
				\node [draw, circle, fill = fgcolor, inner sep = 3pt, below = 0.5 of aRbRcR] (aRbRcRd) {};
