				...
				\subsubsection{Pseudo-Algorithmus zur Festlegung der Koordinatensysteme}
					...
					\paragraph{Schritt 3 (für \( i = 1, \cdots, n - 1 \))}
						...
						\begin{equation*}
							S_i =
								\begin{cases*}
									z_{i - 1} \cap z_i & falls \( (z_{i - 1} \cap z_i) \neq \emptyset \) \\
					...
					\paragraph{Schritt 4 (für \( i = 1, \cdots, n - 1 \))}
						...
						\begin{equation*}
							x_i =
								\begin{cases*}
									x_i \in \big\{\, z_{i - 1} \times z_i,\, z_i \times z_{i - 1} \,\big\} & falls \( (z_{i - 1} \cap z_i) \neq \emptyset \) \\
	...
	\chapter{Regelung} % S.158, S.159, S.160
		\section{Lineare Regelung}
			...
			\subsection{Partitionierung des Regelgesetzes durch Feedback-Linearisierung} % 6.107, 6.108, S.165, S.166
				\todo{!!! Regelung: Partitionierung}
			% end

			\subsection{Sollwerttrajektorien-Folgeregelung} % 6.109, 6.110, S.166, S.167
				\todo{!!! Regelung: Sollwerttrajektorien-Folgeregelung}
			% end
