	...
	\section{Numerical Optimization}
		...
		\subsection{Steepest Descent}
			...
			\subsubsection{Test Functions}
				...
				\begin{figure}
					\centering
					\includegraphics{tmp-steepestDescent-rosenbrock-dark.pdf}
					\caption{Steepest Descent on Rosenbrock}
					\label{fig:steepestDescentExampleRosenbrock}
				\end{figure}
				\begin{figure}
					\centering
					\includegraphics{tmp-steepestDescent-quadratic-dark.pdf}
		...
		\subsection{Newtons Method}
			...
			\subsubsection{Test Functions}
				...
				\begin{figure}
					\centering
					\includegraphics{tmp-newtonsMethod-rosenbrock-dark.pdf}
					\caption{Newtons Method on Rosenbrock}
					\label{fig:newtonsMethodExampleRosenbrock}
				\end{figure}
				\begin{figure}
					\centering
					\includegraphics{tmp-newtonsMethod-quadratic-dark.pdf}
		...
		\subsection{Quasi-Newton Method (BFGS)}
			...
			\subsubsection{Test Functions}
				...
				\begin{figure}
					\centering
					\includegraphics{tmp-bfgs-rosenbrock-dark.pdf}
					\caption{BFGS on Rosenbrock}
					\label{fig:bfgsExampleRosenbrock}
				\end{figure}
				\begin{figure}
					\centering
					\includegraphics{tmp-bfgs-quadratic-dark.pdf}
		...
		\subsection{Conjugate Gradient (CG)}
			...
			\subsubsection{Test Functions}
				...
				\begin{figure} \todo{Opt: CG: Rosenbrock impl. wrong}
					\centering
					\includegraphics{tmp-cg-rosenbrock-dark.pdf}
					\caption{CG on Rosenbrock}
					\label{fig:cgExampleRosenbrock}
				\end{figure}
				\begin{figure}
					\centering
					\includegraphics{tmp-cg-quadratic-dark.pdf}
...
\chapter{Probability Density Estimation}
	...
	\section{Non-Parametric Models}
		...
		\subsection{Histograms}
			...
			\paragraph{Example}
				...
				\begin{figure}
					\centering
					\includegraphics{tmp-nonParametricModels-histogram-dark.pdf}
					\caption{Histogram}
					\label{fig:histogram}
				\end{figure}
			% end
		...
		\subsection{Kernel Density Estimation (KDE)}
			...
			\subsubsection{Parzen Window}
				...
				\paragraph{Example}
					...
					\begin{figure} \todo{PDE: KDE: Parzen impl. wrong}
						\centering
						\includegraphics{tmp-nonParametricModels-kde-parzen-dark.pdf}
			...
			\subsubsection{Gaussian Kernel}
				...
				\paragraph{Example}
					...
					\begin{figure}
						\centering
						\includegraphics{tmp-nonParametricModels-kde-gaussian-dark.pdf}
		...
		\subsection{K-Nearest Neighbors (KNN)}
			...
			\paragraph{Example}
				...
				\begin{figure}
					\centering
					\includegraphics{tmp-nonParametricModels-knn-dark.pdf}
	...
	\section{Mixture Models}
		...
		\subsection{Mixture of Gaussians}
			...
			\begin{figure}
				\centering
				\includegraphics{tmp-mixtureModels-mog-dark.pdf}
		...
		\subsection{Estimation using Clustering}
			...
			\subsubsection{Expectation Maximization (EM)} % TODO: PDE: EM: Intuition; slides: 6A.1, 6A.2, 6A.3, 6A.4, 6A.5, 6A.6, 6A.7, 6A.8, 6A.9
				...
				\paragraph{Gaussian Mixtures}
					...
					\begin{figure}
						\centering
						\includegraphics{tmp-mixtureModels-em-gaussian-dark.pdf}
						\caption{EM for Univariate Gaussian}
...
\chapter{Clustering}
	...
	\begin{figure}
		\centering
		\includegraphics{tmp-clustering-example-dark.pdf}
	...
	\section{Mean Shift Clustering}
		...
		\paragraph{Example} \todo{Clustering: Mean Shift: Impl. wrong}
			...
			\begin{figure}
				\centering
				\includegraphics{tmp-clustering-meanShift-dark.pdf}
				\caption{Mean Shift Clustering}
				\label{fig:meanShiftExample}
			\end{figure}
			\begin{figure}
				\centering
				\includegraphics{tmp-clustering-meanShift-way-dark.pdf}
...
\chapter{Regression}
	...
	\begin{figure}
		\centering
		\includegraphics{tmp-regression-truth-dark.pdf}
	...
	\section{Generalized Linear Regression}
		...
		\paragraph{Example}
			...
			\begin{figure}
				\centering
				\includegraphics{tmp-regression-lsr-dark.pdf}
	...
	\section{Kernel Regression}
		...
		\paragraph{Example}
			...
			\begin{figure}
				\centering
				\includegraphics{tmp-regression-kernel-RBF-1-dark.pdf}
				\caption{Regression: Kernel Regression (RBF, \( \sigma^2 = 0.01 \))}
				\label{fig:regressionKernelA}
			\end{figure}
			\begin{figure}
				\centering
				\includegraphics{tmp-regression-kernel-RBF-100-dark.pdf}
...
\chapter{Classification}
	...
	\begin{figure}
		\centering
		\includegraphics{tmp-classification-separable-dark.pdf}
	...
	\section{Fisher Discriminant Analysis}
		\subsection{Least Squares Classification}
			...
			\paragraph{Example}
				...
				\begin{figure}
					\centering
					\includegraphics{tmp-classification-ls-dark.pdf}
	...
	\section{Perceptron Algorithm} % 9.40, 9.41, 9.42, 9.43, 9.48
		...
		\paragraph{Example}
			...
			\begin{figure}
				\centering
				\includegraphics{tmp-classification-perceptron-dark.pdf}
	...
	\section{Principal Component Analysis}
		...
		\subsection{Conclusion}
			...
			\paragraph{Example}
				...
				\begin{figure}
					\centering
					\includegraphics{tmp-pca-iris-dark.pdf}
					\caption{Principal Component Analysis: Iris Dataset}
					\label{fig:pcaIris}
				\end{figure}
				\begin{figure}
					\centering
					\includegraphics{tmp-pca-variance-dark.pdf}
...
\chapter{Support Vector Machines}
	...
	\section{Linear SVMs}
		...
		\paragraph{Example}
			...
			\begin{figure}
				\centering
				\includegraphics{tmp-svm-linear-dark.pdf}
