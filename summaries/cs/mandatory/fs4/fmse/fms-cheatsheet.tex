...
\begin{document}
    ...
    \chapter{Java Modeling Language (JML)} % 9.2
        ...
        \section{Specification Case} % 9.23
            ...
            \subsection{Normal Behaviour} % 9.19, 10.23
                \todo{Content}
            % end

            \subsection{Exceptional Behaviour} % 10.22, 10.23, 10.24
                \todo{Content}
                ...
                \subsubsection{\texttt{signals_only} } % 10.26
                    \todo{Content}
                % end
            % end
        ...
        \section{Modifiers} % 9.29
            ...
            \subsection{\texttt{spec_public}} % 9.30
                \todo{Content}
            % end
            ...
            \subsection{\texttt{nullable}, \texttt{non_null}} % 10.28, 10.29, 10.30, 10.31, 10.32
                \todo{Content}
            % end
        % end
