...
\chapter{Minimierung von Funktionalen} % 7
	\todo{Content}

	\section{Einleitung} % 7.2, 7.3
		\todo{Content}
	% end

	\section{Charakteristika von Variationsproblemen} % 7.4
		\todo{Content}
	% end

	\section{Euler-Lagrangesche Differentialgleichung} % 7.5, 7.6, 7.9
		\todo{Content}

		\subsection{Beispiel} % 7.10
			\todo{Content}
		% end

		\subsection{Bemerkungen} % 7.11
			\todo{Content}
		% end

		\subsection{Herleitung} % 7.6, 7.7, 7.8, 7.9
			\todo{Content}
		% end
	% end
% end
...
\chapter{Optimale steuerung dynamischer Systeme} % 8.1
	...
	\section{Notwendige Bedingungen für ein Minimum des Basisproblems} % 8.6, 8.7, 8.8
		\todo{Content}
		...
		\subsection{Anwendung: Optimale Robotersteuerung} % 8.13
			...
			\subsubsection{Gütekriterien} % 8.18
				\todo{Content}
			% end
	...
	\section{Bang-Bang und Singuläre Steuerung} % 8.32, 8.33, 8.34
		\todo{Content}

		\subsection{Singuläre Steuerung} % 8.35, 8.36
			\todo{Content}

			\subsubsection{Notwendige Bedingungen für singuläre Steuerung} % 8.37, 8.38
				\todo{Content}
			% end
		% end
	...
	\section{Zustandsbeschränkungen} % 8.53, 8.54, 8.55
		\todo{Content}

		\subsection{Gemischte Ungleichungsbeschränkungen} % 8.56, 8.57
			\todo{Content}
		...
		\subsection{Reine Zustandsungleichungsbeschränkungen} % 8.62, 8.63, 8.65
			\todo{Content}

			\subsubsection{Ordnung einer Zustandsbeschränkung} % 8.66
				\todo{Content}
			% end
...
\chapter{Berechnung optimaler Trajektorien} % 9.2
	...
	\section{Direkte Verfahren} % 9.8, 9.9, 9.10
		...
		\subsection{Direkte Kollokationsverfahren} % 9.11, 9.25
			...
			\subsubsection{Diskretisierung von Ungleichungsbeschränkungen} % 9.22
				\todo{Content}
			% end
			...
			\subsubsection{Validierung der berechneten Lösung} % 9.33
				\todo{Content}
			% end
			...
			\subsubsection{Wahl der Gitterpunkte} % 9.36, 9.37
				...
				\paragraph{Approximative, segmentweise Fehlerschätzung} % 9.38
					\todo{Content}
				% end

				\paragraph{Segmentweise Fehlerschätzung bei zeitkontinuierlichen Nebenbedingungen} % 9.39
					\todo{Content}
				% end

				\paragraph{Segmentweise Schätzung des Optimalitätsfehlers} % 9.40
					\todo{Content}
				% end
			% end
		...
		\subsection{Direkte Schießverfahren} % 9.44, 9.45, 9.46, 9.47
			\todo{Content}
		% end
	% end
...
\chapter{Optimale Rückkopplungssteuerung} % 10.1, 10.2, 10.3
	\todo{Content}
	...
	\section{Benachbarte Extremalen} % 10.20, 10.21, 10.22
		...
		\subsection{Modellgestützte, prädiktive Regelung} % 10.28, 10.29
			\todo{Content}
		% end
	% end

	\section{Numerische Synthese der nichtlinearen Rückkopplungssteuerung} % 10.30, 10.31, 10.32, 10.33
		\todo{Content}
	% end
% end
...
\chapter{Weitere Themen der Optimalen Steuerung} % 11.1
	...
	\section{Lernverfahren und Optimierung} % 11.9
		...
		\subsection{Bezüge zur (optimalen) Steuerung und Regelung} % 11.27, 11.28, 11.29, 11.30
			\todo{Content}
