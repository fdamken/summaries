...
\chapter{Generative Models} % 9b.131, 9b.132, 9b.133, 9a.3, 9a.4, 9a.5, 9a.6, 9a.7, 9a.8
	\todo{Content}
...
\chapter{Attention Models and Transformers} % 12.1, 12.3, 12.4, 12.5, 12.6, 13.2, 13.3, 13.4, 13.5
	\label{c:attention}

	\todo{Content}

	\section{Hard Attention for Recognition} % 12.7, 12.8, 12.9
		\todo{Content}
	% end

	\section{Soft Attention for Translation} % 12.10, 12.11, 12.12, 12.13, 12.14, 12.15, 12.16, 12.17, 12.18, 12.19, 12.20, 12.21, 12.22, 12.23
		\todo{Content}
	% end

	\section{Global and Local Attention Model} % 12.24, 12.25, 12.26
		\todo{Content}
	% end

	\section{Soft Attention for Captioning} % 12.27, 12.28, 12.29, 12.30, 12.31, 12.35
		\todo{Content}

		\subsection{Soft Attention for Video} % 12.32, 12.33, 12.34
			\todo{Content}
		% end
	% end

	\section{Attending to Arbitrary Regions} % 12.36, 12.37
		\todo{Content}

		\subsection{DRAW} % 12.38, 12.39
			\todo{Content}
		% end

		\subsection{Spatial Transformer Networks} % 12.40, 12.41, 12.42, 12.43, 12.44
			\todo{Content}
		% end
	% end
